    ...
    return(
        <div className="loading">
            <svg xmlns="http://www.w3.org/2000/svg"
                 ...
                 version="1.0" width="30px" height="30px" viewBox="0 0 128 128"
                 xml="preserve">
                <g>
                    <linearGradient id="linear-gradient">
                        <stop offset="0%" stopColor="#86a1eb" fillOpacity="1"/>
                        <stop offset="100%" stopColor="#bccbf4" fillOpacity="0.56"/>
                    </linearGradient>
                    <linearGradient id="linear-gradient2">
                        <stop offset="0%" stopColor="#86a1eb" fillOpacity="1"/>
                        <stop offset="100%" stopColor="#e8edfb" fillOpacity="0.19"/>
                    </linearGradient>
